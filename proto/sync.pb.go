...
var fileDescriptor_5273b98214de8075 = []byte{
	...
	,
}
...
func (c *testsClient) GetClientStream(ctx context.Context, opts ...grpc.CallOption) (Tests_GetClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Tests_serviceDesc.Streams[1], "/protos.Tests/GetClientStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &testsGetClientStreamClient{stream}
	return x, nil
}
...
type testsGetClientStreamClient struct {
	grpc.ClientStream
}

func (x *testsGetClientStreamClient) Send(m *Test) error {
	return x.ClientStream.SendMsg(m)
}

func (x *testsGetClientStreamClient) CloseAndRecv() (*MultiTest, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(MultiTest)
...
func (c *testsClient) GetBidirectionalStream(ctx context.Context, opts ...grpc.CallOption) (Tests_GetBidirectionalStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Tests_serviceDesc.Streams[2], "/protos.Tests/GetBidirectionalStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &testsGetBidirectionalStreamClient{stream}
	return x, nil
}
...
type testsGetBidirectionalStreamClient struct {
	grpc.ClientStream
}

func (x *testsGetBidirectionalStreamClient) Send(m *Test) error {
	return x.ClientStream.SendMsg(m)
}

func (x *testsGetBidirectionalStreamClient) Recv() (*Test, error) {
	m := new(Test)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Tests_GetClientStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TestsServer).GetClientStream(&testsGetClientStreamServer{stream})
}
...
type testsGetClientStreamServer struct {
	grpc.ServerStream
}

func (x *testsGetClientStreamServer) SendAndClose(m *MultiTest) error {
	return x.ServerStream.SendMsg(m)
}

func (x *testsGetClientStreamServer) Recv() (*Test, error) {
	m := new(Test)
...
func _Tests_GetBidirectionalStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TestsServer).GetBidirectionalStream(&testsGetBidirectionalStreamServer{stream})
}
...
type testsGetBidirectionalStreamServer struct {
	grpc.ServerStream
}

func (x *testsGetBidirectionalStreamServer) Send(m *Test) error {
	return x.ServerStream.SendMsg(m)
}

func (x *testsGetBidirectionalStreamServer) Recv() (*Test, error) {
	m := new(Test)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var _Tests_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _Tests_GetClientStream_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "GetBidirectionalStream",
			Handler:       _Tests_GetBidirectionalStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
