...
func (m *MockExternalAPI) getToken() error {
	m.ctrl.T.Helper()
...
func (mr *MockExternalAPIMockRecorder) getToken() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "getToken", reflect.TypeOf((*MockExternalAPI)(nil).getToken))
}
